                                    ...
                                    <div class="col-lg-6 col-12">
                                        <div class="product-des">
                                            ...
                                            <div class="short">
                                                ...
                                                @php
                                                    $location_price = $product_detail->getPriceForLocation(App\Helpers\LocationHelper::getCountryCode());
                                                    $after_discount = $location_price - ($location_price * $product_detail->discount / 100);
                                                @endphp
                                                <p class="price"><span class="discount">${{number_format($after_discount, 2)}}</span><s>${{number_format($location_price, 2)}}</s></p>
                                    ...
                                    <div class="single-product">
                                        ...
                                        <div class="product-content">
                                            ...
                                            <div class="product-price">
                                                @php
                                                    $location_price = $data->getPriceForLocation(App\Helpers\LocationHelper::getCountryCode());
                                                    $after_discount = $location_price - ($location_price * $data->discount / 100);
                                                @endphp
