    ...
    <div class="card-body">
      <form method="post" action="{{route('product.update',$product->id)}}">
        ...
        <div class="form-group">
            ...
            <div class="row">
                @php
                    $location_prices = $product->location_prices ?? [];
                @endphp
                <div class="col-md-4">
                    <label for="price_are">Price (ARE)</label>
                    <input type="number" step="0.01" name="location_prices[ARE]" class="form-control" value="{{ old('location_prices.ARE', $location_prices['ARE'] ?? '') }}">
                </div>
                <div class="col-md-4">
                    <label for="price_ksa">Price (KSA)</label>
                    <input type="number" step="0.01" name="location_prices[KSA]" class="form-control" value="{{ old('location_prices.KSA', $location_prices['KSA'] ?? '') }}">
                </div>
                <div class="col-md-4">
                    <label for="price_uae">Price (UAE)</label>
                    <input type="number" step="0.01" name="location_prices[UAE]" class="form-control" value="{{ old('location_prices.UAE', $location_prices['UAE'] ?? '') }}">
                </div>
            </div>
        </div>
